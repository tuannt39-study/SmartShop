...
SET DEFINE OFF;
Insert into SMARTSHOP.FEEDBACK (ID,NAME,EMAIL,PHONE,NOTE,CREATED_TIME) values (1,'Nguyễn Thế Tuân','tuan87@gmail.com','09563856385','Đưa hàng nhanh, chất lượng ok, cảm thấy tốt.',to_timestamp('03-NOV-17 10.31.23.905000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.FEEDBACK (ID,NAME,EMAIL,PHONE,NOTE,CREATED_TIME) values (2,'Dương','duongml@gmail.com','09563856385','Đưa hàng nhanh, chất lượng ok, cảm thấy tốt.',to_timestamp('03-NOV-17 10.31.23.909000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into SMARTSHOP.LOGIN_LOG
SET DEFINE OFF;
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (1,1,'cedL7QgFHUxyFqcordBl',to_timestamp('03-NOV-17 10.29.11.759000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (2,2,'B2EWubuFc327WDIe933z',to_timestamp('03-NOV-17 10.29.11.764000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (3,3,'Is2PzORKprEEoAYkN9fi',to_timestamp('03-NOV-17 10.29.11.768000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (4,4,'yuXCcoyDrEdQVuAZxBS1',to_timestamp('03-NOV-17 10.29.11.775000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (5,5,'2aIjtV13nwZwoyo11qPl',to_timestamp('03-NOV-17 10.29.11.780000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.LOGIN_LOG (ID,USER_ID,TOKEN,LAST_ACCESS) values (6,1,'bRhQfbo50eVHYW2LoAq1',to_timestamp('03-NOV-17 10.29.11.799000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
REM INSERTING into SMARTSHOP.NEW
SET DEFINE OFF;
Insert into SMARTSHOP.NEW (ID,TITLE,BRIEF,CONTENT,CATEGORY_ID,USERS_ID,CREATED_TIME) values (1,'Sao Việt làm ''sống dậy'' xu hướng mũ nồi','Phụ kiện thịnh hành ở những năm 80 - 90 được nhiều người đẹp ''hâm nóng'' trở lại.','Ngày 29 và 30/10 - trước khi Vietnam International Fashion Week Thu đông 2017 chính thức diễn ra, nhiều bạn trẻ Hà Nội đã tập trung ở khu vực gần hồ Hoàn Kiếm để tham gia sự kiện street style. Hầu hết tín đồ thời trang đều tìm cách giúp mình nổi bật bằng những trang phục kiểu dáng khác lạ, màu sắc rực rỡ.  cần quan tâm tổng thể set đồ có rối mắt hay không, họ cố gắng khoác lên mình thật nhiều phụ kiện. Họa tiết dày đặc, phủ kín từ trên xuống dưới được nhiều người lựa chọn. Không ít bạn nam diện đồ unisex, trang điểm và mang giày cao gót như phụ nữ. Quán quân Next Top 2016 Ngọc Châu chọn phong cách khá đơn giản so với nhiều tín đồ thời trang khác.',14,1,to_timestamp('03-NOV-17 10.29.34.427000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SMARTSHOP.NEW (ID,TITLE,BRIEF,CONTENT,CATEGORY_ID,USERS_ID,CREATED_TIME) values (2,'Street style ''quái'' của giới trẻ Hà Nội trước thềm Tuần thời trang quốc tế Việt Nam','Nhiều tín đồ thời trang và cả các mẫu nhí chọn phong cách khác biệt để ghi dấu ấn trên đường phố.','Sau một thời gian dài bị nhấn chìm bởi các xu hướng mũ fedora, mũ snapback, mũ nồi xinh xắn đánh dấu sự trở lại của mình ở mùa mốt thu đông 2017. Góp phần khiến mẫu phụ kiện cổ điển trở nên thu hút hơn là sự lăng xê nhiệt tình của nhiều người đẹp Việt.',15,2,to_timestamp('03-NOV-17 10.29.34.447000000 AM','DD-MON-RR HH.MI.SSXFF AM'));
...
SET DEFINE OFF;
Insert into SMARTSHOP.USERS (ID,EMAIL,USERNAME,FULLNAME,PASSWORD,PHONE,ADDRESS,AVARTAR,CREATED_TIME,STATUS) values (1,'tuan@gmail.com','tuan','Nguyễn Thế Tuân','1234','0963349511','Hà Nội','/assets/layouts/layout/img/avartar.png',to_timestamp('03-NOV-17 10.29.01.939000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ACTIVE');
Insert into SMARTSHOP.USERS (ID,EMAIL,USERNAME,FULLNAME,PASSWORD,PHONE,ADDRESS,AVARTAR,CREATED_TIME,STATUS) values (2,'duong@gmail.com','duong','Mặt Dương','1234','0963349512','Hà Nội','/assets/layouts/layout/img/avartar.png',to_timestamp('03-NOV-17 10.29.01.947000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ACTIVE');
Insert into SMARTSHOP.USERS (ID,EMAIL,USERNAME,FULLNAME,PASSWORD,PHONE,ADDRESS,AVARTAR,CREATED_TIME,STATUS) values (3,'duc@gmail.com','duc','BD Đức','1234','0963349513','Hà Nội','/assets/layouts/layout/img/avartar.png',to_timestamp('03-NOV-17 10.29.01.959000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ACTIVE');
Insert into SMARTSHOP.USERS (ID,EMAIL,USERNAME,FULLNAME,PASSWORD,PHONE,ADDRESS,AVARTAR,CREATED_TIME,STATUS) values (4,'linh@gmail.com','linh','Nguyễn Linh','1234','0963349514','Hà Nội','/assets/layouts/layout/img/avartar.png',to_timestamp('03-NOV-17 10.29.01.963000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ACTIVE');
Insert into SMARTSHOP.USERS (ID,EMAIL,USERNAME,FULLNAME,PASSWORD,PHONE,ADDRESS,AVARTAR,CREATED_TIME,STATUS) values (5,'thinh@gmail.com','thinh','Nguyễn Thịnh','1234','0963349515','Hà Nội','/assets/layouts/layout/img/avartar.png',to_timestamp('03-NOV-17 10.29.01.967000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'ACTIVE');
