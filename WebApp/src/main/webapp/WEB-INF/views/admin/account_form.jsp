                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Tài Khoản Form</span>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Tài Khoản Form </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="tab-pane active">
                                        <div class="portlet box grey-cascade">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Tài Khoản Form
                                                </div>
                                                <div class="tools">
                                                ...
                                                <form action="#" id="form_sample_2" class="form-horizontal">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="password" class="form-control input-circle" name="password" /> 
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control input-circle" name="fullname" /> 
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Quyền
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-4">
                                                                <select class="form-control input-circle" name="select">
