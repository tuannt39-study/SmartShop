                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="/WebApp/admin/product/form" ><button id="sample_editable_1_new" class="btn sbold green"> Thêm sản phẩm
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    <td> 1 </td>
                                                    <td> Pigofashion - Áo Khoác dù nam hàn quốc SAK25 (xanh đen)  </td>
                                                    <td> 269.000 VND </td>
                                                    ...
                                                    <td>
                                                        <span class="label label-sm label-default"> Hết hàng </span>
                                                    </td>
                                                    <td>
                                                        <span class="label label-sm label-warning"> Sửa </span>
                                                    </td>
                                                </tr>
                                                <tr class="odd gradeX">
                                                    <td> 2 </td>
                                                    ...
                                                    <td> Thời trang nam </td>
                                                    <td>
                                                        <span class="label label-sm label-danger"> HOT </span>
                                                    </td>
                                                    <td>
                                                        <span class="label label-sm label-warning"> Sửa </span>
                                                    </td>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td> Thời trang nam </td>
                                                    <td>
                                                        <span class="label label-sm label-info"> Mới nhập </span>
                                                    </td>
                                                    <td>
                                                        <span class="label label-sm label-warning"> Sửa </span>
                                                    </td>
