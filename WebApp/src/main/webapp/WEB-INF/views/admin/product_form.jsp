            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Sản phẩm Form </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="tab-pane active">
                                        <div class="portlet box grey-cascade">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Sản phẩm Form
                                                </div>
                                                <div class="tools">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form action="#" id="form_sample_2" class="form-horizontal">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Khuyến mãi
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-4">
                                                                <div class="input-icon right">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control input-circle" name="select">
                                                                    ...
                                                                    <option value="Mới nhật">Mới nhật</option>
