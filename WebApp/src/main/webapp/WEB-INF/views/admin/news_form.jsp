                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Bài viết Form</span>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Bài viết Form </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="tab-pane active">
                                        <div class="portlet box grey-cascade">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Bài viết Form
                                                </div>
                                                <div class="tools">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form action="#" id="form_sample_2" class="form-horizontal">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Chuyên mục
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-4">
                                                                <select class="form-control input-circle" name="select">
                                                                    ...
                                                                    <option value="Sao Style">Sao Style</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea style="width: 650px; height: 200px;" name="tomtat"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
