                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Quản lý đơn đặt hàng </span>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td> 0965836593 </td>
                                                    <td> tuannt39@gmail.com </td>
                                                    <td> Tòa nhà 3A, 82 Duy Tân, Cầu Giấy, Hà Nội </td>
                                                    <td> 9500000 </td>
                                                    <td> tuannt39 </td>
                                                    <td> 30-10-2017 20:09:40 </td>
                                                    <td> 
                                                        <span class="label label-sm label-success"> Xong </span>
                                                    </td>
                                                    <td> 
                                                        <span class="label label-sm label-warning"> Sửa </span>&emsp;
                                                        <a href="bill.html"><span class="label label-sm label-danger"> Chi tiết </span></a>
                                                    </td>
                                                </tr>
                                                <tr class="odd gradeX">
                                                    <td> 2 </td>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td> 30-10-2017 20:09:40 </td>
                                                    <td> 
                                                        <span class="label label-sm label-info"> Đang giao hàng </span>
                                                    </td>
                                                    <td> 
                                                        <span class="label label-sm label-warning"> Sửa </span>&emsp;
                                                        <a href="bill.html"><span class="label label-sm label-danger"> Chi tiết </span></a>    
